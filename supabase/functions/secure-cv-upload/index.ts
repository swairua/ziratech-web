...
// Note: Origin validation removed as JWT auth + rate limiting + file validation provide sufficient security
// CORS is already configured to handle cross-origin requests properly
